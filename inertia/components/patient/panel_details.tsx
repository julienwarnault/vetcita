  ...
  return (
    <Drawer.MainPanel className="grid grid-rows-[auto_1fr]">
      <Drawer.Header className="border-none px-8 pt-8">
        <h1 className="text-[28px]/9 font-semibold">Datos del paciente</h1>
      </Drawer.Header>
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-[15px]/5 font-normal text-muted">{patient.fullName}</div>
            </div>
            <div>
              <div className="text-[15px]/5 font-medium">Correo electrónico</div>
              <div className="text-[15px]/5 font-normal text-muted">{patient.email || '-'}</div>
            </div>
            <div>
