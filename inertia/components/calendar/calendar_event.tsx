    ...
    <CalendarEventPreviewCard event={event}>
      ...
      >
        <div className="flex flex-nowrap items-start w-full">
          <div className="flex flex-wrap items-center gap-1 w-[calc(100%-16px-1px)]">
          ...
          {!event.status.isDefault && (
            <div className="flex size-4 items-center justify-between">
              <DynamicIcon name={event.status.icon as IconName} size={15} />
            </div>
          )}
        </div>
